...
class BarcodeAnalyzer(
    private val barcodeListener: (barcodeValue: String,barcodeFormat:String,barcodeValueType:Int, imageBitmap:Bitmap?) -> Unit//
   ...
   // var image: FirebaseVisionImage = FirebaseVisionImage.fromBitmap(bitmap)
    ...
    override fun analyze(imageProxy: ImageProxy) {
        ...
        if (mediaImage != null) {
            ...
            val crop = Bitmap.createBitmap(ori, rect.left, rect.top, rect.width(), rect.height())// bitmap image
            ...
            scanner.process(image)
                .addOnSuccessListener { barcodes ->
                    ...
                    for (barcode in barcodes) {
                        ...
                        barcodeListener(barcode.rawValue ?: "", barcode.format.toString(),barcode.valueType, image.bitmapInternal )
